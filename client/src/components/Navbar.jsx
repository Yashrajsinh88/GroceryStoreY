            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        {/* FIXED DROPDOWN */}
                        <ul className='absolute hidden group-hover:block top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-32
                        rounded-md text-sm z-40 transition-all duration-200 ease-out'>
                            <li
                ...
                <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden">
                    ...
                    {!user ? (
                        <button
                            ...
                            className="cursor-pointer px-6 py-2 mt-2 bg-amber-600 hover:bg-primary-dull transition text-white rounded-full text-sm"
                        >
                            Login
                        </button>
                    ) : (
